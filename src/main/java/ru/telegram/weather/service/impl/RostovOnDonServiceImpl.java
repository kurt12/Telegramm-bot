...
import ru.telegram.weather.service.RostovOnDonService;

@Service
@RequiredArgsConstructor
public class RostovOnDonServiceImpl implements RostovOnDonService {
    ...
    public SendMessage handle(long chatId, Message message) {
        ...
        String textWeather = getWeatherRostovOnDonNowFromYandexApiMessage(weather.getFact(), weather);
    ...
    public BotState getHandlerName() {
        return BotState.ROSTOV_ON_DON;
    }

    private String getWeatherRostovOnDonNowFromYandexApiMessage(Fact fact, Weather weather) {
